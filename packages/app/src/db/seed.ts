...
export const SEED_MODELS: NewModel[] = [
  ...
  // @see https://openai.com/api/pricing
  {
    ...
    outputPrice: 10,
    markupRate: 1,
    ...openaiCacheWithWrite(2),
    ...openaiLongContext(2, 10),
  },
  // 短名 alias → Sol（与 OpenAI API 一致）
  {
    id: 'gpt-6',
  ...
  },
  {
    ...
    outputPrice: 0.5,
    markupRate: 1,
    ...openaiCacheWithWrite(0.1),
    ...openaiLongContext(0.1, 0.5),
  },
  {
    id: 'gpt-5',
    provider: 'openai',
  ...
  // Claude Opus 5.5（2026-09-22 发布）：Claude 5.5 先锋，运行成本较 Opus 5 降 40%
  // 官方定价：input $4 / output $20，prompt caching 读单价 $0.20/1M（5%），写单价 $5.00/1M（1.25× input）
  {
    id: 'claude-opus-5-5',
    provider: 'anthropic',
  ...
  // Xiaomi MiMo-V2.6 系列（2026-09-22 发布）：原生全模态支持音频直收，1M 上下文不加价，限时免 Cache 写入费
  // 定价与 V2.5 相当：Flash 输入 $0.14 / 输出 $0.28 (¥1/¥2)，Pro 输入 $0.435 / 输出 $0.87 (¥3/¥6)
  {
    id: 'mimo-v2.6-pro',
    provider: 'xiaomi-mimo',
    upstreamModelId: 'mimo-v2.6-pro',
    inputPrice: 0.435,
    outputPrice: 0.87,
    markupRate: 1,
  ...
  },
  {
    id: 'mimo-v2.6-flash',
    provider: 'xiaomi-mimo',
    upstreamModelId: 'mimo-v2.6-flash',
    inputPrice: 0.14,
    outputPrice: 0.28,
    markupRate: 1,
    cachedInputPrice: 0.0028,
  ...
  },
  {
    ...
    provider: 'xiaomi-mimo',
    upstreamModelId: 'mimo-v2.6-pro-ultraspeed',
    inputPrice: 4.35,
    outputPrice: 8.7,
    markupRate: 1,
