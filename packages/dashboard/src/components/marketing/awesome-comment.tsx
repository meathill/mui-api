...
function loadStylesheet(): void {
  const cssUrl = 'https://unpkg.com/@roudanio/awesome-comment@0.12.1/dist/style.css';
    ...
    async function loadAndInit(target: HTMLDivElement) {
      ...
      try {
        const [authModule, commentModule] = await Promise.all([
          ...
          import(
            /* webpackIgnore: true */ 'https://unpkg.com/@roudanio/awesome-comment@0.12.1/dist/awesome-comment.js'
          ),
        ]);
