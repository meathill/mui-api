...
```
                 ...
                 ┌───────────────┴───────────────┐
                 ▼                               ▼
      【High-Volume / Filter】            【Core Business Logic】
        GPT-5.6 Luna                     GPT-5.6 Terra
      ($0.20 / $1.20)                  ($2.00 / $12.00)
    • Intent classification            • Standard feature coding
    • RAG filtering & parsing          • Unit testing & PR reviews
    • Agent trial-and-error            • Structured API generation
                 │                               │
                 └───────────────┬───────────────┘
                                 │ (Complex architecture / Hard bugs)
                                 ▼
                      【Frontier Reasoning / Mastermind】
                           GPT-5.6 Sol
                         ($4.00 / $20.00)
                       • Cross-file system refactoring
                       • Complex math & multi-hop logic
                       • High-autonomy agent decisions
```
