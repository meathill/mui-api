...
```
                 ...
                 ┌───────────────┴───────────────┐
                 ▼                               ▼
      【Alto volumen / Filtro】           【Lógica de negocio principal】
        GPT-5.6 Luna                     GPT-5.6 Terra
      ($0.20 / $1.20)                  ($2.00 / $12.00)
    • Detección de intenciones         • Escritura de lógica de negocio
    • Filtrado y parseo RAG            • Tests unitarios y revisión de PR
    • Exploración de ramas de agentes  • Generación de APIs estructuradas
                 │                               │
                 └───────────────┬───────────────┘
                                 │ (Arquitectura compleja / Errores críticos)
                                 ▼
                     【Razonamiento de vanguardia】
                           GPT-5.6 Sol
                         ($4.00 / $20.00)
                       • Refactorización de sistemas multifichero
                       • Lógica matemática avanzada
                       • Decisiones de agentes de alta autonomía
```
