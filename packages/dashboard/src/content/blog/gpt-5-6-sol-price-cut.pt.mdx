...
```
                 ...
                 ┌───────────────┴───────────────┐
                 ▼                               ▼
       【Alto volume / Filtro】           【Lógica de negócio central】
         GPT-5.6 Luna                     GPT-5.6 Terra
       ($0.20 / $1.20)                  ($2.00 / $12.00)
    • Detecção de intenção             • Codificação de recursos
    • Filtro RAG e pré-processamento   • Testes unitários e revisão de PR
    • Exploração em árvore de agentes  • Geração de APIs estruturadas
                 │                               │
                 └───────────────┬───────────────┘
                                 │ (Arquitetura complexa / Bugs críticos)
                                 ▼
