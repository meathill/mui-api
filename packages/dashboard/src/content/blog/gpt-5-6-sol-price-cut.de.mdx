...
```
                 ...
                 ┌───────────────┴───────────────┐
                 ▼                               ▼
       【Hohes Volumen / Filter】         【Zentrale Geschäftslogik】
         GPT-5.6 Luna                     GPT-5.6 Terra
       (0,20 $ / 1,20 $)                (2,00 $ / 12,00 $)
    • Intent-Klassifikation            • Reguläre Feature-Entwicklung
    • RAG-Vorfilterung & Extraktion    • Unit-Tests & PR-Reviews
    • Explorative Agent-Pfade          • Strukturierte API-Generierung
                 │                               │
                 └───────────────┬───────────────┘
                                 │ (Komplexe Architektur / Harte Fehler)
                                 ▼
                     【Spitzen-Reasoning / Flaggschiff】
                            GPT-5.6 Sol
                          (4,00 $ / 20,00 $)
                       • Dateiübergreifendes Refactoring
                       • Anspruchsvolle mathematische Logik
                       • Vollautonome Agent-Entscheidungen
```
